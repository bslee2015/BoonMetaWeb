        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <li class="dropdown">
                        <a href="faq" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Sign Up <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="https://docs.google.com/forms/d/1bmzyZ2ZQFiWmx19EkWhjp1WrlnkY3kumq2vqvJwv7Cc/viewform?c=0&w=1" target="_blank">Meta Sign Up</a></li>
                            <li><a href="https://sisglow2016.typeform.com/to/DQy7U1" target="_blank">Glow Sign Up</a></li>
                        </ul>
                    </li>
...
<div class="container">
    ...
    <section>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-sm-offset-3">
                <div class="story-container">
                    <p class="fittext ring "> Sponsor wall </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4 ">
                <div  class="story-container story">
                    <p class="fittext uppercase ring"> Platinum sponsors </p>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-2">
                <div  class="dot-container">
                    <div class='dot center' data-delay="4"></div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4 ">
                <div  class="story-container story">
                    <p class="fittext uppercase ring" data-delay="6"> Gold Sponsors </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-xs-12 col-sm-3 ">
                <div class="story-image-container">
                    <div class="circle-icon " data-delay="1">
                        <img src="img/logo-facebook.png" alt=" robot icon">
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-3 ">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-sm-offset-3">
                <div  class="story-container story">
                    <p class="fittext ring"> A big thank you to </p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-sm-offset-3">
                <div  class="story-container story">
                    <p class="fittext ring"> All our lovely sponsors </p>
                </div>
            </div>
        </div>

        <div class="color-change" data-colorup="#000000" data-colordown="#3498DB"></div>

        <div class="row">
            <div class="col-xs-12 col-sm-6">
                <div  class="story-container story">
                    <p class="fittext ring " data-margin="50" data-delay="3">From our Meta Team! </p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 ">
                <div class="story-image-container">
                    <img src="img/meta-comm.jpg" alt="Meta Org">
                </div>
            </div>
        </div>
